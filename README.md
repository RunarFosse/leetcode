...
## Easy
 ...
 | [apple-redistribution-into-boxes.py](Easy/apple-redistribution-into-boxes.py) | O(mlog m + n) | O(m) | <a href="https://leetcode.com/problems/apple-redistribution-into-boxes/" target="_blank">Link</a>
 ...
 | [binary-gap.py](Easy/binary-gap.py) | O(log n) | O(1) | <a href="https://leetcode.com/problems/binary-gap/" target="_blank">Link</a>
 | [binary-number-with-alternating-bits.py](Easy/binary-number-with-alternating-bits.py) | O(log n) | O(1) | <a href="https://leetcode.com/problems/binary-number-with-alternating-bits/" target="_blank">Link</a>
 | [binary-prefix-divisible-by-5.py](Easy/binary-prefix-divisible-by-5.py) | O(n) | O(n) | <a href="https://leetcode.com/problems/binary-prefix-divisible-by-5/" target="_blank">Link</a>
 ...
 | [count-commas-in-range.py](Easy/count-commas-in-range.py) | O(1) | O(1) | <a href="https://leetcode.com/problems/count-commas-in-range/" target="_blank">Link</a>
 ...
 | [count-partitions-with-even-sum-difference.py](Easy/count-partitions-with-even-sum-difference.py) | O(n) | O(1) | <a href="https://leetcode.com/problems/count-partitions-with-even-sum-difference/" target="_blank">Link</a>
 ...
 | [count-square-sum-triples.py](Easy/count-square-sum-triples.py) | O(n^2) | O(n) | <a href="https://leetcode.com/problems/count-square-sum-triples/" target="_blank">Link</a>
 ...
 | [largest-perimeter-triangle.py](Easy/largest-perimeter-triangle.py) | O(nlog n) | O(n) | <a href="https://leetcode.com/problems/largest-perimeter-triangle/" target="_blank">Link</a>
 ...
 | [minimum-absolute-difference.py](Easy/minimum-absolute-difference.py) | O(nlog n) | O(n) | <a href="https://leetcode.com/problems/minimum-absolute-difference/" target="_blank">Link</a>
 ...
 | [shift-2d-grid.py](Easy/shift-2d-grid.py) | O(mn) | O(1) | <a href="https://leetcode.com/problems/shift-2d-grid/" target="_blank">Link</a>
 ...
 | [smallest-stable-index-i.py](Easy/smallest-stable-index-i.py) | O(n) | O(n) | <a href="https://leetcode.com/problems/smallest-stable-index-i/" target="_blank">Link</a>
...
## Medium
 ...
 | [best-time-to-buy-and-sell-stock-using-strategy.py](Medium/best-time-to-buy-and-sell-stock-using-strategy.py) | O(n) | O(1) | <a href="https://leetcode.com/problems/best-time-to-buy-and-sell-stock-using-strategy/" target="_blank">Link</a>
 | [best-time-to-buy-and-sell-stock-v.py](Medium/best-time-to-buy-and-sell-stock-v.py) | O(nk) | O(k) | <a href="https://leetcode.com/problems/best-time-to-buy-and-sell-stock-v/" target="_blank">Link</a>
 ...
 | [construct-uniform-parity-array-ii.py](Medium/construct-uniform-parity-array-ii.py) | O(n) | O(1) | <a href="https://leetcode.com/problems/construct-uniform-parity-array-ii/" target="_blank">Link</a>
 ...
 | [count-commas-in-range-ii.py](Medium/count-commas-in-range-ii.py) | O(log n) | O(1) | <a href="https://leetcode.com/problems/count-commas-in-range-ii/" target="_blank">Link</a>
 | [count-complete-subarrays-in-an-array.py](Medium/count-complete-subarrays-in-an-array.py) | O(n) | O(n) | <a href="https://leetcode.com/problems/count-complete-subarrays-in-an-array/" target="_blank">Link</a>
 ...
 | [length-of-longest-fibonacci-subsequence.py](Medium/length-of-longest-fibonacci-subsequence.py) | O(n^2) | O(n^2) | <a href="https://leetcode.com/problems/length-of-longest-fibonacci-subsequence/" target="_blank">Link</a>
 ...
 | [maximize-active-section-with-trade-i.py](Medium/maximize-active-section-with-trade-i.py) | O(n) | O(1) | <a href="https://leetcode.com/problems/maximize-active-section-with-trade-i/" target="_blank">Link</a>
 ...
 | [maximum-ice-cream-bars.py](Medium/maximum-ice-cream-bars.py) | O(m + n) | O(m) | <a href="https://leetcode.com/problems/maximum-ice-cream-bars/" target="_blank">Link</a>
 ...
 | [maximum-level-sum-of-a-binary-tree.py](Medium/maximum-level-sum-of-a-binary-tree.py) | O(n) | O(n) | <a href="https://leetcode.com/problems/maximum-level-sum-of-a-binary-tree/" target="_blank">Link</a>
 ...
 | [minimize-hamming-distance-after-swap-operations.py](Medium/minimize-hamming-distance-after-swap-operations.py) |  |  | <a href="https://leetcode.com/problems/minimize-hamming-distance-after-swap-operations/" target="_blank">Link</a>
 ...
 | [minimum-absolute-difference-in-sliding-submatrix.py](Medium/minimum-absolute-difference-in-sliding-submatrix.py) | O(kmnlog k) | O(mn) | <a href="https://leetcode.com/problems/minimum-absolute-difference-in-sliding-submatrix/" target="_blank">Link</a>
 ...
 | [minimum-distance-between-three-equal-elements-ii.py](Medium/minimum-distance-between-three-equal-elements-ii.py) | O(n) | O(n) | <a href="https://leetcode.com/problems/minimum-distance-between-three-equal-elements-ii/" target="_blank">Link</a>
 ...
 | [minimum-operations-to-reduce-x-to-zero.py](Medium/minimum-operations-to-reduce-x-to-zero.py) | O(n) | O(1) | <a href="https://leetcode.com/problems/minimum-operations-to-reduce-x-to-zero/" target="_blank">Link</a>
 ...
 | [next-greater-numerically-balanced-number.py](Medium/next-greater-numerically-balanced-number.py) | O(n) | O(log n) | <a href="https://leetcode.com/problems/next-greater-numerically-balanced-number/" target="_blank">Link</a>
 ...
 | [partition-array-such-that-maximum-difference-is-k.py](Medium/partition-array-such-that-maximum-difference-is-k.py) | O(nlog n) | O(n) | <a href="https://leetcode.com/problems/partition-array-such-that-maximum-difference-is-k/" target="_blank">Link</a>
 ...
 | [remove-covered-intervals.py](Medium/remove-covered-intervals.py) | O(nlog n) | O(n) | <a href="https://leetcode.com/problems/remove-covered-intervals/" target="_blank">Link</a>
 ...
 | [rotate-list.py](Medium/rotate-list.py) | O(n) | O(1) | <a href="https://leetcode.com/problems/rotate-list/" target="_blank">Link</a>
 ...
 | [shortest-and-lexicographically-smallest-beautiful-string.py](Medium/shortest-and-lexicographically-smallest-beautiful-string.py) | O(n) | O(n) | <a href="https://leetcode.com/problems/shortest-and-lexicographically-smallest-beautiful-string/" target="_blank">Link</a>
 ...
 | [smallest-stable-index-ii.py](Medium/smallest-stable-index-ii.py) | O(n) | O(n) | <a href="https://leetcode.com/problems/smallest-stable-index-ii/" target="_blank">Link</a>
 ...
 | [sum-game.py](Medium/sum-game.py) | O(n) | O(1) | <a href="https://leetcode.com/problems/sum-game/" target="_blank">Link</a>
 ...
 | [taking-maximum-energy-from-the-mystic-dungeon.py](Medium/taking-maximum-energy-from-the-mystic-dungeon.py) | O(n) | O(1) | <a href="https://leetcode.com/problems/taking-maximum-energy-from-the-mystic-dungeon/" target="_blank">Link</a>
 ...
 | [vowels-game-in-a-string.py](Medium/vowels-game-in-a-string.py) | O(n) | O(1) | <a href="https://leetcode.com/problems/vowels-game-in-a-string/" target="_blank">Link</a>
 ...
 | [words-within-two-edits-of-dictionary.py](Medium/words-within-two-edits-of-dictionary.py) | O(mk + nk^3) | O(mk) | <a href="https://leetcode.com/problems/words-within-two-edits-of-dictionary/" target="_blank">Link</a>
 | [xor-after-range-multiplication-queries-i.py](Medium/xor-after-range-multiplication-queries-i.py) | O(mn) | O(1) | <a href="https://leetcode.com/problems/xor-after-range-multiplication-queries-i/" target="_blank">Link</a>
...
## Hard
 ...
 | [count-subarrays-with-majority-element-ii.py](Hard/count-subarrays-with-majority-element-ii.py) | O(n) | O(n) | <a href="https://leetcode.com/problems/count-subarrays-with-majority-element-ii/" target="_blank">Link</a>
 | [count-subarrays-with-score-less-than-k.py](Hard/count-subarrays-with-score-less-than-k.py) | O(n) | O(1) | <a href="https://leetcode.com/problems/count-subarrays-with-score-less-than-k/" target="_blank">Link</a>
 ...
 | [distinct-subsequences-ii.py](Hard/distinct-subsequences-ii.py) | O(n) | O(1) | <a href="https://leetcode.com/problems/distinct-subsequences-ii/" target="_blank">Link</a>
 ...
 | [maximize-the-distance-between-points-on-a-square.py](Hard/maximize-the-distance-between-points-on-a-square.py) | O(nk(log n)(log m)) | O(n) | <a href="https://leetcode.com/problems/maximize-the-distance-between-points-on-a-square/" target="_blank">Link</a>
 ...
 | [maximum-walls-destroyed-by-robots.py](Hard/maximum-walls-destroyed-by-robots.py) | O((m log m + nlog n) | O(m + n) | <a href="https://leetcode.com/problems/maximum-walls-destroyed-by-robots/" target="_blank">Link</a>
 ...
 | [separate-squares-ii.py](Hard/separate-squares-ii.py) | O(nlog n) | O(n) | <a href="https://leetcode.com/problems/separate-squares-ii/" target="_blank">Link</a>
 ...
 | [shortest-palindrome.py](Hard/shortest-palindrome.py) | O(n) | O(n) | <a href="https://leetcode.com/problems/shortest-palindrome/" target="_blank">Link</a>
